    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-10 max-w-4xl">
        <p className="text-muted-foreground mb-8">
          Desktop connectors let you upload files and PDFs directly from your computer. Platform builds are rolling out.
        </p>
        <div className="grid md:grid-cols-3 gap-6">
          <Card>
            ...
            <CardContent className="space-y-3">
              <p className="text-sm text-muted-foreground">Beta build</p>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <p className="text-sm text-muted-foreground">Universal build</p>
              <Button disabled className="w-full" variant="outline">
                <Download className="h-4 w-4 mr-2" /> Coming soon
              </Button>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <p className="text-sm text-muted-foreground">x64 build</p>
              <Button disabled className="w-full" variant="outline">
                <Download className="h-4 w-4 mr-2" /> Coming soon
              </Button>
            </CardContent>
